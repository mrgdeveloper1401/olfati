    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_field', models.CharField(blank=True, max_length=50)),
                ('username', models.CharField(blank=True, max_length=30)),
                ('melli_code', models.CharField(blank=True, max_length=20)),
                ('phone_number', models.CharField(max_length=12, unique=True, validators=[utils.vlaidations.PhoneValidator()])),
