  ...
  #  permission_classes = [IsAuthenticated]
    ...
    def post(self, request, pk):
        ...
        try:    
            ...
            if request.data:
                ...
                data['karname'] = []
            serializer = TakeExamSerializer(data= data, context={'request':request, 'exam':pk})
            try:
                serializer.is_valid()
            except Exception:
    ...
    def put(self, request, pk):
        ...
        if request.data:
            ...
            data['karname'] = []
        exam = get_object_or_404(ExamModel, pk=pk)
        karname = get_object_or_404(KarNameModel, user= request.user, exam_id= exam)
        serializer = TakeExamSerializer(instance=karname, data=data, context={'request':request, 'exam':pk}, partial=True)
