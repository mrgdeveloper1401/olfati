...
class MyLitnerclass(CreateMixin, UpdateMixin):
    class Meta:
...
class LitnerModel(CreateMixin, UpdateMixin):
    class Meta:
        db_table = "linter"
        verbose_name = 'فصل'
    ...
    cover_image = models.ImageField(upload_to='media/linter_image_cover/', validators=[validate_image_size],
                                    verbose_name='عکس کاور')
    price = models.FloatField(verbose_name='قیمیت فصل')
    myclass = models.ForeignKey(MyLitnerclass, related_name='linter', on_delete=models.PROTECT,
...
class LeitnerBox(CreateMixin, UpdateMixin):
    ...
    linter = models.ForeignKey(LitnerModel, on_delete=models.PROTECT, verbose_name="فصل", related_name="linter_box")
...
class UserProgress(models.Model):
    ...
    linter = models.ForeignKey(LitnerModel, on_delete=models.PROTECT, related_name='user_progress')
