...
from litner.views import LitnerListView, LitnerView, ListCreateMyClassView, LitnerTakingExam, ListProfileMyClassView, \
...
urlpatterns = [
    ...
    path('class-list/<int:pk>/',
         ListCreateMyClassView.as_view({'get': 'retrieve', 'put': 'partial_update', 'delete': 'destroy'})),
