...
from litner.models import LitnerModel, LitnerQuestionModel, LitnerKarNameModel,LitnerKarNameDBModel,LitnerModel,LitnerAnswer
...
class LitneKarnameDBSerializer(serializers.ModelSerializer):
    class Meta:
...
class LitnerTakeExamSerializer(serializers.ModelSerializer):
    karname = LitneKarnameDBSerializer(LitnerKarNameDBModel.objects.all(),many = True)
    class Meta:
        model = LitnerKarNameModel
        fields = '__all__'
